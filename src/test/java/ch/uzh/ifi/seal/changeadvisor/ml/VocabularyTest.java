...
public class VocabularyTest {
    ...
    private List<Set<String>> tokensByDocument;

    private List<String> flatTokenList;

    private HashSet<String> tokens1;

    private HashSet<String> tokens2;

    private HashSet<String> tokens3;
    ...
    public void setUp() throws Exception {
        ...
        tokens1 = Sets.newHashSet(Splitter.on(" ").split(doc1));
        tokens2 = Sets.newHashSet(Splitter.on(" ").split(doc2));
        tokens3 = Sets.newHashSet(Splitter.on(" ").split(doc3));
    ...
    private void assertTokens(Set<String> tokens, Map<String, Integer> ids, List<Integer> document) {
