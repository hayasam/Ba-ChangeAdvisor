...
public class ReviewImportService {
    ...
    public JobExecution reviewImport(Map<String, Object> params) throws JobService.FailedToRunJobException {
        Job reviewImport = reviewImportJobFactory.job(params);
        return jobService.run(reviewImport);
    }

    public JobExecution reviewAnalysis(ReviewAnalysisDto dto) throws JobService.FailedToRunJobException {
